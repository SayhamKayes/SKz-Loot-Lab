...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SKz Lab — Your Ultimate Gaming Hub" },
      { name: "description", content: "Instant game top-ups, premium gaming gear, lightning-fast delivery." },
      { name: "author", content: "SKz Lab" },
